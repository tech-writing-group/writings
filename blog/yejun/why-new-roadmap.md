...
예를 들어 아래와 같은 케이스에 대해 고민해볼 수 있다
...
한번 케이스를 읽어봤다면, 뜬금없는 면접 질문보다 훨씬 실무와 연관된 문제를 다루고 있다는 것을 알 수 있을 것이다. 그리고 개발 과정에 대한 전반적인 요소를 다루고 있음을 알 수 있다.
...
구직자에게는 실무 중심으로 문제 해결 능력을 기를 수 있는 기회가 되고, 면접관에게는 좋은 개발자를 채용하기 위한 예시 질문이 될 것이다.
